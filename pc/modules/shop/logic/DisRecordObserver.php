...
class DisRecordObserver{
			...
			$account_records[$key] = $recordItem;
				...
				$Ds_Record_ID = $this->DisRecord['Record_ID'];
                        ...
                        foreach ($diff_user as $ks => $vs) {
                            ...
                            $account_records[$i]['skustr'] = $Product['skustr'];
							$account_records[$i]['skukey'] = $Product['skukey'];
	...
	private function generateDistributeAccountRecord(){
		...
		foreach ($ancestors_rsort as $key => $value) {
			...
			$dis_account_records[$key]['skustr'] = $Product['skustr'];
			$dis_account_records[$key]['skukey'] = $Product['skukey'];
		}
