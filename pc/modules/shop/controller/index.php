...
class indexController extends controllController {
	...
	public function indexOp() {
		$title = model('pc_setting')->field('site_title')->where(array('module' => 'shop', 'Users_ID'=>$this->UsersID))->find();
		$this->assign('title', $title['site_title']);
		...
		$block_list = $model_pc_index->getWebList(array('web_page' => 'index','Users_ID'=>$this->UsersID,'web_show'=>1));
