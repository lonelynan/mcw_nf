	...
	<div class="hot_prodice">
		...
		<div class="hp_list">
			...
			<div class="list_word">
				...
				<div class="bb_proce"><span>￥<?php echo (empty(intval($val["products_pricea"]))) ? $val["products_pricex"] : $val["products_pricea"];?></span></div>
			</div>
		</div>
		<?php }?>
		<?php }?>
		    ...
		    <?php foreach($output['Recommend'] as $key => $val){?>
				<li class="1">
					...
					<div class="beibi_tui_word"><a style="height:15px;overflow:hidden;" href="<?php echo $val['link'];?>">
						...
						</a><span>￥<?php echo (empty(intval($val["products_pricea"]))) ? $val["products_pricex"] : $val["products_pricea"];?></span><i>￥<?php echo $val['products_pricey'];?></i></div>
				</li>
			<?php }?>
			<?php }?>
			</ul>
