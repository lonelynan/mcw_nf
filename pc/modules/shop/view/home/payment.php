<link href='<?php echo $output['_site_url'];?>/static/pc/shop/css/cart.css?t=1' rel="stylesheet" type="text/css" />
<script src='<?php echo $output['_site_url'];?>/static/pc/shop/js/payment.js?t=1'></script>
<script>
