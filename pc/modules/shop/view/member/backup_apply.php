				  ...
				  <div class="information">
					...
					<?php 
					  if($output['item']['Property']){
							$prciecenter = $output['item']['Property']['shu_pricesimp'];							
					  }else{
							$prciecenter = $output['item']['ProductsPriceX'];
					  }
					  ?>
					  <li> <img class="img" src="<?=$output['item']['ImgPath']?>"><a class="word" href="<?=url('goods/index',array('id'=>$output['ProductsID']))?>"><?=$output['item']['ProductsName']?></a><br><span class="word"><?=$output['item']['Productsattrstrval']?></span></li>
					  <li>单价：<span>￥<?=$prciecenter?></span></li>
