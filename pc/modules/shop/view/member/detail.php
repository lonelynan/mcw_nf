    ...
    <div class="body">
        ...
        <div class="body_center_pub all_dingdan">
			<div class="ddxq_top"> 
                            ...
                            <?php if(!empty($output['rsOrder']['Order_Code'])){ ?>
						...
						<div class="dd_more"> 
						    <span id="ddxq_name" style="overflow:hidden;"><img title="<?php echo $v['ProductsName'];?>" src="<?php echo $v['ImgPath'];?>" style="width:150px;float:left; margin-right:10px;">
								<div style="float:left;">
									<a href="<?php echo url('goods/index', array('id'=>$key));?>"><?php echo $v['ProductsName'];?></a><br><?php echo $v['Productsattrstrval'];?>									
								</div>
							</span> 
							<?php 
							  if($v['Property']){
									$prciecenter = $v['Property']['shu_pricesimp'];							
							  }else{
									$prciecenter = $v['ProductsPriceX'];
							  }
							  ?>
							<span id="ddxq_price"><i><?php echo $prciecenter?></i></span> 
							<span id="ddxq_num"><?php echo $v['Qty'];?></span> 
							<span id="ddxq_truepay"><?php echo '￥' . $prciecenter*$v['Qty'];?></span>
					...
					<div class="dingdan">
						<div class="dd_more"> 
						    <span id="ddxq_name" style="overflow:hidden;"><img title="<?php echo $CartList_back['ProductsName'];?>" src="<?php echo $CartList_back['ImgPath'];?>" style="width:150px;float:left; margin-right:10px;">
								<div style="float:left;">
									<a href="<?php echo url('goods/index', array('id'=>$item['ProductID']));?>"><?php echo $CartList_back['ProductsName'];?></a><br><?php echo $CartList_back['Productsattrstrval'];?>
								</div>
							</span> 
							<?php 
							  if($CartList_back['Property']){
									$prcieback = $CartList_back['Property']['shu_pricesimp'];							
							  }else{
									$prcieback = $CartList_back['ProductsPriceX'];
							  }
							  ?>
							<span id="ddxq_price"><i><?php echo $prcieback?></i></span> 
							<span id="ddxq_num"><?php echo $CartList_back['Qty'];?></span> 
							<span id="ddxq_truepay"><?php echo '￥' . $prcieback*$CartList_back['Qty'];?></span>
