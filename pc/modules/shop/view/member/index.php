...
<div class="my_con">
    <div class="body">
		...
		<div class="body_center_pub my_dingdan">
			...
			<?php
			if($v['Property']){
				$price = $v['Property']['shu_pricesimp'];
				$imgpath = $v['Property']['showimg'];
			}else{
				$price = $v['ProductsPriceX'];
				$imgpath = $v['products_img'];
			}
			?>
				<div class="dd_nt"> <span>订单编号:<i><?php echo $v['order_sn'];?></i></span><span>成交时间：<i><?php echo $v['Order_CreateTime'];?></i></span> </div>
				<div class="dd_more"> 
				    <span class="name"><img src="<?php echo $imgpath;?>">
						<div>
							<a href="<?php echo $v['products_url']?>"><?php echo $v['ProductsName']?></a>
							<?php if($v['Property']){ ?>							
							<br><span><?php echo $v['Property']['shu_value']?></span><br>							
							<?php }?>
						</div>
					</span> 
					<span class="price"><i><?php echo $v['ProductsPriceY']?></i><br><?php echo $price?></span> 
				...
				<ul>
					...
					<li>
						...
						<div class="sc_word">
							...
							<div class="andmore"><span>￥<?php echo (empty(intval($v["Products_PriceA"]))) ? $v["Products_PriceX"] : $v["Products_PriceA"];?></span><i>￥<?php echo $v['Products_PriceY']?></i></div>
						</div>
					</li>
					<?php }?>
					<?php }?>
