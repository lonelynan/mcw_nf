...
$unifiedOrder->setParameter("notify_url","http://".$_SERVER['HTTP_HOST']."/pay/wxpay2/notify_sha.php");
			...
			WeixinJSBridge.invoke(
				...
				function(res){
					...
					if(res.err_msg=='get_brand_wcpay_request:ok'){
						window.location.href = 'http://<?php echo $_SERVER['HTTP_HOST'];?>/pay/wxpay2/notify_sha.php?OrderID=<?php echo $OrderID;?>';
					}
				}
			);
		}
