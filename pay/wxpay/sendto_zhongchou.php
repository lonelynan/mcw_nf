...
$wxPayHelper->setParameter("notify_url", "http://".$_SERVER['HTTP_HOST']."/pay/wxpay/zhongchou_url.php");
...
function callpay()
{
	...
	if(res.err_msg=='get_brand_wcpay_request:ok'){
		...
		setTimeout("window.location.href = 'http://<?php echo $_SERVER['HTTP_HOST'];?>/pay/wxpay/zhongchou_url.php?OrderID=<?php echo $OrderID;?>'",2000);
	}else{
