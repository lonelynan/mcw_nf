...
$wxPayHelper->setParameter("partner", $rsPay["PaymentWxpayPartnerKey"]);
$wxPayHelper->setParameter("out_trade_no", strval($pay_orderno));
$wxPayHelper->setParameter("total_fee", strval(floatval($pay_fee)));
$wxPayHelper->setParameter("fee_type", "1");
$wxPayHelper->setParameter("notify_url", "http://".$_SERVER['HTTP_HOST']."/pay/wxpay/pintuan_url.php");
...
function callpay()
{
	...
	if(res.err_msg=='get_brand_wcpay_request:ok'){
		...
		setTimeout("window.location.href = 'http://<?php echo $_SERVER['HTTP_HOST'];?>/pay/wxpay/pintuan_url.php?OrderID=<?php echo $OrderID;?>'",2000);
	}else{
