...
require_once($_SERVER["DOCUMENT_ROOT"].'/Framework/FF/vendor/alipay/pc/Notify.php');
    ...
    $payinfo = array(
        ...
        'subject'=>'商家平台使用年费在线付款，订单编号:'.$orderinfo['id'],
  ...
  //  $rsUsers=$DB->GetRs("users","*","where Users_ID='".$UsersID."'");
    ...
    $notify_url = "http://".$_SERVER['HTTP_HOST']."/biz/authen/pay/alipay/notify_url_man.php";//服务器异步通知页面路径
    $return_url = "http://".$_SERVER['HTTP_HOST']."/biz/authen/pay/alipay/return_url_man.php";//页面跳转同步通知页面路径
