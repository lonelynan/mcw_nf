...
require_once($_SERVER["DOCUMENT_ROOT"].'/Framework/FF/vendor/alipay/pc/Notify.php');
    ...
    $payinfo = array(
        ...
        'subject'=>'商家保证金在线付款，订单编号:'.$orderinfo['id'],
  ...
  //  $rsUsers=$DB->GetRs("users","*","where Users_ID='".$UsersID."'");
    ...
    $notify_url = "http://".$_SERVER['HTTP_HOST']."/biz/authen/pay/alipay/notify_url_bond.php";//服务器异步通知页面路径
    $return_url = "http://".$_SERVER['HTTP_HOST']."/biz/authen/pay/alipay/return_url_bond.php";//页面跳转同步通知页面路径
