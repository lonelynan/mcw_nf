...
<div id="iframe_page">
	<div class="iframe_content">
		...
		<div id="products" class="r_con_wrap">
			...
			<form class="r_con_form" id="product_add_form" method="post" action="products_edit.php">
				<div class="rows">
					<label>产品名称</label>
					<span class="input">
				...
				<div class="rows">
					<label>活动期数</label>
					<span class="input">
					<input type="text" name="Cloud_num" value="<?php echo $rsProducts["Products_Cloud_num"] ?>" class="form_input" size="10" maxlength="100" />
					</span>
					<div class="clear"></div>
				</div>
				<div class="rows">
				...
				<div class="rows">
					...
					<div class="img" id="PicDetail">
						...
						<div><a target="_blank" href="<?php echo $value ?>"> <img src="<?php echo $value ?>"></a><span onclick="imgdel(this);">删除</span>
