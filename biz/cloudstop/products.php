...
$condition .= " ORDER BY Products_Status ASC,Products_ID DESC";
      ...
      <table width="100%" align="center" border="0" cellpadding="5" cellspacing="0" class="r_con_table">
        <thead>
          <tr>
            ...
            <td width="5%" nowrap="nowrap">当前期数</td>
            <td width="5%" nowrap="nowrap">总期数</td>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td nowrap="nowrap"><b><?php echo $rsProducts["Products_Cloud_num"] ?></b>&nbsp;期</td>
			...
			<?php if(empty($rsProducts["canyurenshu"])){?>
			    <a href="products_edit.php?ProductsID=<?php echo $rsProducts["Products_ID"] ?>">[编辑]</a>
			<?php }?>
