...
if ($_POST) {
    ...
    if(empty($_POST['PriceX']) || $_POST['PriceX']<0){
	    echo '<script language="javascript">alert("购买价格不能为空");history.back();</script>';
	    exit;
	}
    ...
    $Data = array(
		...
		"Products_Cloud_num"=>isset($_POST['Cloud_num']) && !empty($_POST['Cloud_num']) ? $_POST['Cloud_num'] : 100,
...
<script type='text/javascript' src='/static/member/js/cloud.js?t=<?=time();?>'></script>
<style>
.r_con_form .rows .input .error { color:#f00; }
.error,.fc_red { margin-left:20px;}
.fc_red_1 {margin-left:20px;color:#f00;}
</style>
</head>
				...
				<form id="product_add_form" class="r_con_form" method="post"
					...
					<div class="rows">
						<label>排序</label> <span class="input"> <input type="text"
							...
							maxlength="100" /><font class="fc_red">*</font>
						</span>
						<div class="clear"></div>
					</div>
					<div class="rows">
						<label>活动期数</label>
					<span class="input">
					<input type="text" name="Cloud_num" value="0" class="form_input" size="10" maxlength="100" />
					</span>
						<div class="clear"></div>
					</div>
					<div class="rows">
					...
					<div class="rows">
						<label>限购次数</label> <span class="input price"> <input type="text" name="xiangoutimes" value="0" class="form_input" size="5"
							maxlength="10" /> <span>(0或空表示不限制)</span><font class="fc_red_1">*</font>
							<font class="fc_red"></font>
						</span>
						<div class="clear"></div>
					</div>
					...
					<div class="rows">
						<label>产品重量</label> <span class="input"> <input type="text"
							...
							size="5" />&nbsp;&nbsp;千克<font class="fc_red_1">*</font>
							<font class="fc_red"></font>
						</span>
						<div class="clear"></div>
					</div>
					...
					<input type="radio" value="1" name="Products_IsShippingFree" />
							免运费&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;</label><label> <input type="radio"
					...
					<div class="rows">
						<label></label> <span class="input"> <input type="submit"
							class="btn_green" name="submit_button" value="提交保存" /> <a href="javascript:window.history.go(-1);"
