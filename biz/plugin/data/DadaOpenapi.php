...
class DadaOpenapi{
    ...
    public function __construct($config){
        ...
        isset($config['source_id']) ? $this->source_id = $config['source_id'] : '';
    ...
    public function makeRequest($data){
        $reqParams = $this->bulidRequestParams(json_encode($data, JSON_UNESCAPED_UNICODE));
        $resp = $this->getHttpRequestWithPost($this->url, json_encode($reqParams, JSON_UNESCAPED_UNICODE));
