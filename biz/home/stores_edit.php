...
$rsStores=$DB->GetRs("biz_stores","*","where Users_ID='".$_SESSION["Users_ID"]."' and Biz_ID=".$_SESSION['BIZ_ID']." and Stores_ID=".$StoresID);
if($_POST)
{
    //开始事务定义
    $Flag=true;
    ...
    $Set=$DB->Set("biz_stores",$Data,"where Users_ID='".$_SESSION["Users_ID"]."' and Biz_ID=".$_SESSION['BIZ_ID']." and Stores_ID=".$StoresID);
    $Flag=$Flag&&$Set;

    if($Flag){
        mysql_query("commit");
        echo '<script language="javascript">alert("修改成功");window.location="stores.php";</script>';
    }else{
...
<!--                --><?php //}?>
        ...
        <div id="stores" class="r_con_wrap">
            ...
            <form id="stores_form" class="r_con_form" method="post" action="stores_edit.php">
                <div class="rows">
                    <label>门店名称</label>
                    <span class="input">
          ...
          <font class="fc_red">*</font></span>
                ...
                <div class="rows">
                    <label>联系电话</label>
                    <span class="input">
          <input class="form_input" maxlength="11" name="Telephone" value="<?php echo $rsStores["Stores_Telephone"] ?>">
          </span>
                    <div class="clear"></div>
                </div>
                <div class="rows">
