...
if($_POST){
	...
	if($do_action=='shop.home_diy'){
		...
		$Flag=$DB->Set("biz_home",$Data,"where Users_ID='".$_SESSION["Users_ID"]."' and Skin_ID=".$rsConfig['Biz_Skin_ID'].' AND Biz_ID ='.$_SESSION["BIZ_ID"]);
			// echo '<pre>';
	// print_R($_POST);
	// exit;
		if($Flag){
...
function CategoryList(){
  ...
  $DB->get("biz_category","*","where Users_ID='".$_SESSION["Users_ID"]."' and Category_ParentID=0 and Biz_ID=".$_SESSION["BIZ_ID"]." order by Category_Index asc");
  ...
  foreach($ParentCategory as $key=>$value){
    $DB->get("biz_category","*","where Users_ID='".$_SESSION["Users_ID"]."' and Category_ParentID=".$value["Category_ID"]." order by Category_Index asc");
    if($DB->num_rows()>0){
...
function UrlList(){
	...
	$DB->get("biz_category","*","where Users_ID='".$_SESSION["Users_ID"]."'and Biz_ID='".$_SESSION["BIZ_ID"]."' and Category_ParentID=0 order by Category_Index asc");
	$ParentCategory=array();
	$i=1;
	while($rsPCategory=$DB->fetch_assoc()){
		$ParentCategory[$i]=$rsPCategory;
	...
	foreach($ParentCategory as $key=>$value){
		$DB->get("biz_category","*","where Users_ID='".$_SESSION["Users_ID"]."' and Category_ParentID=".$value["Category_ID"]." order by Category_Index asc");
		if($DB->num_rows()>0){
			echo '<option value="/api/'.$_SESSION["Users_ID"].'/biz/'.$_SESSION["BIZ_ID"].'/products/'.$value["Category_ID"].'/">'.$value["Category_Name"].'</option>';
			while($rsCategory=$DB->fetch_assoc()){
				echo '<option value="/api/'.$_SESSION["Users_ID"].'/biz/'.$_SESSION["BIZ_ID"].'/products/'.$rsCategory["Category_ID"].'/">&nbsp;&nbsp;├'.$rsCategory["Category_Name"].'</option>';
			}
		}else{
			echo '<option value="/api/'.$_SESSION["Users_ID"].'/biz/'.$_SESSION["BIZ_ID"].'/products/'.$value["Category_ID"].'/">'.$value["Category_Name"].'</option>';
		}
  ...
  <div class="iframe_content">
   <div class="r_nav">
      <ul>
        ...
        <li><a href="come_stores.php">到店自提管理</a></li>
      </ul>
    </div>
	...
	<div style="width:100%; background:#FFF; padding:10px 0px">
		...
		function openwin(){
			...
			window.open('/api/<?php echo $_SESSION["Users_ID"];?>/biz/<?=$rsSkin['Biz_ID']?>/','','height=750,width=480,top='+win_top+',left='+win_left+',toolbar=no,menubar=no,scrollbars=yes,resizable=no,location=no,status=no');
		}
		</script>
	</div>
    ...
    var Skin_ID  = "<?php echo $rsConfig['Biz_Skin_ID'];?>";
    $(function(){
        shop_obj.diy_init();
                              ...
                              if($value['list_type'] == '1') {
                                echo '<div class="chanpint_x">
                                  <ul>';
                                    for($i=0;$i<$num;$i++) {
                                      echo '<li>
                                        <a href="#"><span class="cpt_x l"><img src="/static/api/shop/skin/'.$rsConfig['Biz_Skin_ID'].'/tp01.jpg"></span></a>
                                        <span class="cpxq_x l">
                                          ...
                                          if(isset($cart)) {
                                            echo '<span class="r" style="margin-top:3px;"><img src="/static/api/shop/skin/'.$rsConfig['Biz_Skin_ID'].'/gwct_x.png" width="20" height="20"></span>';
                                          }
                                        echo '</span>
                                      </li>';  
                                    }
                                ...
                                echo '<div class="chanpint1_x">
                                  ...
                                  for($i=0; $i<$num; $i++) {
                                    echo '<li>
                                      <a href="#"><span class="cpt_x"><img src="/static/api/shop/skin/'.$rsConfig['Biz_Skin_ID'].'/tp01.jpg"></span></a>
                                        <div class="cpxq1_x">
                                          <div class="cpbt_x"><a href="#">蛋糕蛋糕蛋糕蛋糕</a></div>';
                                          if(isset($integration)) {
                                ...
                                echo '<div class="chanpint2_x">
                                  ...
                                  for($i=0;$i<$num;$i++) {
                                    echo '<li>
                                      <a href="#"><span class="cpt_x"><img src="/static/api/shop/skin/'.$rsConfig['Biz_Skin_ID'].'/tp03.jpg"></span></a>
                                        <div class="cpxq1_x">
                                          <div class="cpbt_x"><a href="#">蛋糕蛋糕蛋糕蛋糕</a></div> ';
                                          if(isset($integration)) {
                                ...
                                echo '<div class="chanpint3_x">
                                  ...
                                  for($i = 0;$i < $n;$i++){
                                    echo '<li>
                                      <span class="big_pr l">
                                        <a href="#">';
                                        echo '<div class="pic"><img src="/static/api/shop/skin/'.$rsConfig['Biz_Skin_ID'].'/tp01.jpg"></div>';
                                        if(isset($cart)){
                                          echo '<div class="name">小苹果小苹果小苹果小苹果小苹果小苹果小苹果<br><span class="price l">￥123.00</span><span class="r" style="margin-top:3px; margin-right:3px"><img src="/static/api/shop/skin/'.$rsConfig['Biz_Skin_ID'].'/gwct_x.png" width="20" height="20"></span></div>';
                                        }else{
                                      ...
                                      <span class="smal_pr l">
                                        <div class="small_pr">
                                              ...
                                              <span class="pic l"><img src="/static/api/shop/skin/'.$rsConfig['Biz_Skin_ID'].'/tp03.jpg"></span>
                                              </a>
                                          </div> 
                                          <div class="clear"></div>
                                          <div>
                                              <a href="#">
                                              <span class="name l"><span class="price">￥150.00</span><br>阿卡卡</span>
                                              <span class="pic l"><img src="/static/api/shop/skin/'.$rsConfig['Biz_Skin_ID'].'/tp02.jpg"></span>
                                              </a>
                                          </div>                  
                                      </span>
                                    </li>';  
