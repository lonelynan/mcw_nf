...
if(isset($_GET["action"])){
    if($_GET["action"]=="del"){
        $Flag=$DB->Del("biz_stores","Users_ID='".$_SESSION["Users_ID"]."' and Stores_ID=".$_GET["StoresID"]." and Biz_ID=".$_SESSION['BIZ_ID']);
        if($Flag){
...
<!--                --><?php //}?>
        ...
        <div id="stores" class="r_con_wrap">
            <div class="control_btn"> <a href="stores_add.php" class="btn_green btn_w_120">新增门店</a>
            ...
            <table border="0" cellpadding="5" cellspacing="0" class="r_con_table">
                ...
                <tbody>
                <?php $DB->getPage("biz_stores","*","where Users_ID='".$_SESSION["Users_ID"]."' and Biz_ID=".$_SESSION['BIZ_ID']." order by Stores_ID asc",10);
                while($rsStores=$DB->fetch_assoc()){?>
                    <tr>
                        ...
                        <td class="last"><a href="stores_edit.php?StoresID=<?php echo $rsStores["Stores_ID"] ?>"><img src="/static/member/images/ico/mod.gif" align="absmiddle" alt="修改" /></a> <a href="stores.php?action=del&StoresID=<?php echo $rsStores["Stores_ID"] ?>" onClick="if(!confirm('删除后不可恢复，继续吗？')){return false};"><img src="/static/member/images/ico/del.gif" align="absmiddle" alt="删除" /></a></td>
                    </tr>
                <?php }?>
                </tbody>
            </table>
