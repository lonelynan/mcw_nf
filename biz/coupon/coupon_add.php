    ...
    <div id="coupon_list" class="r_con_wrap">
      ...
      <form id="coupon_list_form" class="r_con_form" method="post" action="?">
        ...
        <div class="rows">
            <label>优惠方式</label>
            <span class="input">
                <input type="radio" name="UseType" value="0" checked="checked" />折扣 <input name="Discount" class="form_input" value="" size="5" /> <span style="color:red;">注：在0-1之间，1为不打折，折扣不能小于0.85</span>
