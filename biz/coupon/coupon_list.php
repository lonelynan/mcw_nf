...
if(isset($_GET["action"]))
{
	...
	if($action=="del")
	{
		$Flag = $DB->Set("user_coupon",array('Is_Delete'=>1),"where Biz_ID=".$_SESSION["BIZ_ID"]." and Coupon_ID=".$_GET["CouponID"]);
		if($Flag){
  ...
  <div class="iframe_content">
    ...
    <div id="coupon_list" class="r_con_wrap">
      <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0" class="r_con_table">
        ...
        <tbody>
          <?php $DB->getPage("user_coupon","*","where Biz_ID=".$_SESSION["BIZ_ID"]." AND Is_Delete=0 order by Coupon_CreateTime desc",$pageSize=10);
		$i=1;
