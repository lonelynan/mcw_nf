...
$condition = "WHERE `User_ID` = '".$rsBiz["Users_ID"]."' AND Card_Status=0 AND Biz_ID='" .$rsBiz['Biz_ID']. "'";
$psize = 10;
...
<style type="text/css">
	...
	#actionBox a{display:block;width:50px;height:20px;float:left;margin-right:20px;background:#ccc;color:#545353;text-align:center;padding:5px 10px;text-decoration: none;}
</style>
</head>
  ...
  <div class="iframe_content">
    ...
    <div id="products" class="r_con_wrap"> 
      ...
      <table width="100%" align="center" border="0" cellpadding="5" cellspacing="0" class="r_con_table">
    	...
    	<?php
	    	$List = Array();
	    	$DB->getPage("shop_virtual_card","*",$condition,$psize);
	    	while ($r=$DB->fetch_assoc()) { $List[] = $r; }
	    	foreach ($List as $k => $v) {
				$rsType = $capsule->table('shop_virtual_card_type')->where(['Type_Id' => $v['Type_Id']])->first(['Type_Name']);
        ?>
	        <tr>
...
<script type="text/javascript" src="/static/member/js/choice_virtual_card.js?t=<?php echo time(); ?>"></script>
</body>
</html>