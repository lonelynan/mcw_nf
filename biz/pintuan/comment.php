      ...
      ?>
          <tr>
            ...
            <td nowrap="nowrap"><?php echo date("Y-m-d H:i:s",$rsCommit["CreateTime"]) ?></td>
              <td nowrap="nowrap"><a href="?action=<?php echo $_Check[$rsCommit["Status"]];?>&ItemID=<?php echo $rsCommit["Item_ID"] ?>" title="<?php echo $_Title[$rsCommit["Status"]];?>"><?php echo $_Status[$rsCommit["Status"]] ?></a>&nbsp;&nbsp;&nbsp;
                    <a href="?action=del&ItemID=<?php echo $rsCommit["Item_ID"] ?>" title="删除" onClick="if(!confirm('删除后不可恢复，继续吗？')){return false};"><img src="/static/member/images/ico/del.gif" align="absmiddle" /></a>
            </td>
           </tr>
          <?php }?>
        </tbody>
