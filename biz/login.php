...
if($_POST){
	...
	if($rsBiz){
		...
		$rsUsers = $DB->GetRs("users","*","where Users_ID='".$rsBiz['Users_ID']."'");
		if(!$rsUsers){
			session_unset();
...
<body>
<link href='style/login.css?t=123' rel='stylesheet' type='text/css' />
	...
	<form id="login" method="post" action="?">
    	<div class="login_form">
            ...
            <div class="form">
                ...
                <div class="submit"><input type="submit" value="" name="submit"><span><a href="forgetpwd.php">忘记密码？</a></span></div>
