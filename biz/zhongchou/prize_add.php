...
<div id="iframe_page">
  <div class="iframe_content">
    ...
    <div class="r_con_wrap">
      <form id="prize_form_submit" class="r_con_form" method="post" action="prize_add.php">
      	<div class="rows">
          <label>支持金额</label>
          <span class="input">
          <input name="money" value="" type="text" class="form_input" size="20" notnull>
          <font class="fc_red_1">* </font>(支持金额必须大于零)<font class="fc_red"></font></span>
          <div class="clear"></div>
        </div>
        <div class="rows">
          <label>赠品名称</label>
        ...
        <div class="rows">
          <label>奖品重量</label>
          <span class="input">
			<input name="Weight" type="text" value="0" class="form_input" size="10" /> kg
          </span>
          <div class="clear"></div>
        </div>
		<div class="rows">
