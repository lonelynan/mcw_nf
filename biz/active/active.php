...
$condition = "LEFT JOIN active AS a ON b.Active_ID=a.Active_ID WHERE b.Users_ID = '{$UsersID}' AND b.Biz_ID={$BizID} AND Type_ID={$TypeID} ORDER BY b.Status ASC,b.ID DESC";
	    ...
	    ?>      
          <tr>
            ...
            <td class="last" nowrap="nowrap">
            	<?php if($v['Status']<4){?>
            	<a href="active_edit.php?id=<?php echo $v["ID"]; ?>&TypeID=<?=$TypeID ?>"><img src="/static/member/images/ico/mod.gif" align="absmiddle" alt="修改" /></a>&nbsp;&nbsp;
				      <?php 
                  }
                  //if($v['Status']!=2){
              ?>
