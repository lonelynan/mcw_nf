...
$builder = Dis_Record::where('Biz_ID',$_SESSION["BIZ_ID"])->with("Order")->with('DisAccountRecord')->with('product');
$url_param = array();	
	...
	<div class="iframe_content">
		...
		<div id="user" class="r_con_wrap">
			...
			echo empty($user_dropdown[$rsRecord['Owner_ID']]) ? '' : $user_dropdown[$rsRecord['Owner_ID']];?></td>
						...
						<td nowarp="nowrap">
                            <?php
                                if($rsRecord['order']['Order_Type'] == 'offline' || $rsRecord['order']['Order_Type'] == 'offline_qrcode'){
