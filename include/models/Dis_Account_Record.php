...
class Dis_Account_Record extends Illuminate\Database\Eloquent\Model {
	...
	public function recordMoneySum($Users_ID, $Begin_Time, $End_Time, $Record_Status = '') {
        ...
        //已付款佣金
    public function recordMoneySum2($Users_ID, $Begin_Time, $End_Time, $Record_Status = '') {
        ...
        //提现佣金
    public function recordMoneySum3($Users_ID, $Begin_Time, $End_Time, $Record_Status = '') {
        ...
        public function recordMoneySum4($Users_ID,$Begin_Time,$End_Time,$Record_Type,$Record_Status = '') {
		$builder = $this->where('Users_ID', $Users_ID)
		               ->whereBetween('Record_CreateTime', [$Begin_Time, $End_Time]);
        ...
        public function recordMoneySum5($Users_ID,$Begin_Time,$End_Time,$Record_Type,$Record_Status = '') {
		$builder = $this->where('Users_ID', $Users_ID)
		               ->whereBetween('Record_CreateTime', [$Begin_Time, $End_Time]);
