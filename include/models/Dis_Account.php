...
class Dis_Account extends Illuminate\Database\Eloquent\Model {
	 ...
	 */
	 /*edit in 20160328*/
	public function getPosterity($level,$force=false, $type = 'uids') {
		...
		if ($type != 'uids') {
			...
			return $this->whereIn('User_ID', $ids)->orderBy('Account_ID','desc')->get($fields)->filter(function (&$dsAccount) use ($level, $User_ID) {
