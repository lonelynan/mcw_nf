...
$(document).ready(function(){		
        ...
        var PriceT = parseFloat($.trim(value));
        var PriceD = parseFloat($.trim($("input[name='PriceD']").val()));
        if(PriceD<PriceT){
          return false;
        }
        return true;     
      ...
      messages: {
        ...
        BriefDescription:{
          required: "请输入简短介绍",
          minlength:"简短介绍在2到240个字符之间",
          maxlength:"简短介绍在2到240个字符之间",
          isArticle:"简短介绍必需由英文字母、汉字和标点符号组成"
        },
        Peoplenum:{
            required: "请输入拼团人数",
            number:"拼团人数必须为数字",
