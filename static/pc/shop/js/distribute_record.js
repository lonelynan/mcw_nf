				...
				success:function(data){
					if(data['list'] != '') {
						...
						$.each(data['list'],function(i) {
							v = data['list'][i];
							if (v['Products_PriceAamx'] == 0) {
								vprice = v['Products_PriceX'];
							}else{
								vprice = v['Product_Price'];
							}
							htmltmp += '<div class="bottom">'+
											...
											'<div class="fenxiaochanpin">'+
												...
												'<div class="word">'+
													'<a class="name" style="width:247px;" href="'+v['P_URL']+'">'+v['Products_Name']+'</a><br>'+v['skustr']+'<br>'+
													'<span class="price">￥'+vprice+'</span>'+
												'</div>'+
											'</div>'+
