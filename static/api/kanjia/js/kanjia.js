...
var kanjia_obj = {
    ...
    buy_init: function() {
		...
		$('#order_form input[name=Shipping_ID]').click(function(){
			var fee = parseFloat($(this).attr("fee"));
			var price = parseFloat($("#total_price").attr("value"));
			var total = fee+price;
			$("#total_price_txt").html(total+" 元");
		});
        ...
        $("#submit").click(function() {
            ...
            $.post("/api/kanjia/ajax.php?UsersID=" + UsersID, params, function(data) {
