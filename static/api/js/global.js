...
var global_obj={
	...
	/*
		...
		*/
		if($('.support').length > 0){
			var $UID = window.location.href.substr(parseInt(SiteUrl.length+5), 10);
			var a = '';
			var b = '';
			var i = 0;
			var len = $UID.length;
			for (; i < len; i++) {
			    a += $UID.charCodeAt(i).toString(16);
			};
			if(a && (a == '613278686c39796d3434' || a == '79673132316335647364')){
				var r = '\u6280'+
				'\u672f'+
				'\u652f'+
				'\u6301'+
