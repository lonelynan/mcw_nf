...
<?php if(!empty($rsOrder["Order_PaymentMethod"])){ ?>
    <div class="item">
      <ul>
        ...
        <?php if($rsOrder["Order_PaymentMethod"]=="线下支付"){ ?><li>支付信息: <?php echo $rsOrder["Order_PaymentInfo"] ?><a href="/api/<?php echo $UsersID ?>/shop/cart/payment/<?php echo $rsOrder["Order_ID"] ?>/?love" class="red"><strong>修改支付信息</strong></a></li><?php }?>
      </ul>
    </div>
<?php }?>
    <div class="item">
