...
if(!empty($rsOrder['Address_Province'])){
	$rsOrder['Address_Province'] = $province_list[$rsOrder['Address_Province']].',';
}
$City = '';
if(!empty($rsOrder['Address_City'])){
	$rsOrder['Address_City'] = $area_array['0,'.$rsOrder['Address_Province']][$rsOrder['Address_City']].',';
}

$Area = '';
if(!empty($rsOrder['Address_Area'])){
	$rsOrder['Address_Area'] = $area_array['0,'.$rsOrder['Address_Province'].','.$rsOrder['Address_City']][$rsOrder['Address_Area']];
}
?>
<!DOCTYPE html>
<html>
...
<div id="shop_page_contents">
  ...
  <ul id="member_nav">
    ...
    <li class=""><a href="/api/<?php echo $UsersID ?>/shop/member/address/?love">地址簿</a></li>
    <?php }?>
  </ul>
  <div id="order_detail">
    <div class="item">
...
foreach($CartList as $key=>$value){
	foreach($value as $k=>$v){
		...
		echo '<div class="pro">
			<div class="img"><a href="/api/'.$UsersID.'/shop/products/'.$key.'/?love"><img src="'.$v["ImgPath"].'" width="100" height="100"></a></div>
			<dl class="info">
    ...
    <?php if($rsOrder["Order_Status"]==0){ ?><div class="payment"><a href="/api/<?php echo $UsersID ?>/shop/cart/payment/<?php echo $rsOrder["Order_ID"] ?>/?love">付款</a></div><?php }?>
	<?php if($rsOrder["Order_Status"]==3 && $rsOrder["Is_Commit"]==0){ ?><div class="payment"><a href="/api/<?php echo $UsersID ?>/shop/member/commit/<?php echo $rsOrder["Order_ID"] ?>/?love">评论</a></div><?php }?>
  </div>
</div>
...
<footer id="footer">
  <ul>
    ...
    <li class="cart"><a href="/api/<?php echo $UsersID ?>/shop/cart/?love">购物车</a></li>
    <li class="member"><a href="/api/<?php echo $UsersID ?>/shop/member/?love">会员中心</a></li>
    <li class="home"><a href="/api/<?php echo $UsersID ?>/shop/?love">商城首页</a></li>
  </ul>
</footer>
<div id="category">
  <div class="close"></div>
