...
<div id="rank">
	...
	foreach($lists as $k=>$v){
		...
		$face = empty($usersinfo["User_HeadImg"]) ? '/static/api/games/images/no_img.jpg' : $usersinfo["User_HeadImg"];
		$nickname = empty($usersinfo["User_NickName"]) ? "匿名" : $usersinfo["User_NickName"];
	?>
