...
if (! empty($addresslist)) {
    ...
    foreach($cart as $res){
        ...
        $result = DB::table("pintuan_products")->where(["Products_ID" => $res['goodsid'], "Users_ID" => $UsersID])
            ->first();
        ...
        $pintuanshop['Products_Weight'] = $result['Products_Weight'];
        $pintuanshop['Is_Draw'] = $result['Is_Draw'];
        $pintuanshop['Biz_ID'] = $result['Biz_ID'];
