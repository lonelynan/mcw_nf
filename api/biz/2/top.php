...
<body>
 <div id="header_biz">
  ...
  <ul><?php //PRINT_R($_SERVER['HTTP_HOST'])?>
   <li><a href="<?php echo $shop_url;?>union/" class="shop_home">首页</a></li>    
   <li><a href="<?php echo $shop_url;?>wzw/" class="shop_cart">购物</a></li>
   <li><a href="/api/<?php echo $_GET['UsersID'];?>/distribute/" class="shop_dis">开店</a></li>
   <li class="last"><a href="<?php echo $shop_url;?>member/" class="shop_member">我的</a></li>
  </ul>
 </div>