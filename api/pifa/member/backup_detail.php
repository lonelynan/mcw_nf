  ...
  <div id="order_detail">
	  ...
	  echo '<div class="pro">
			...
			<dl class="info" style="margin-top:0px; margin-bottom:0px; padding:0px">
				<dd class="name" style="margin:0px; padding:0px"><a href="/api/'.$UsersID.'/pifa/product/'.$rsBackup["ProductID"].'/">'.$CartList_back["ProductsName"].'</a></dd>				
    ...
    <div class="item">
      <ul>
        ...
        <li><a href="<?php echo $base_url;?>api/<?php echo $UsersID;?>/pifa/member/backup/detail_send/<?php echo $BackID;?>/" style="display:block; width:100px; height:30px; line-height:28px; color:#FFF; background:#F60; border-radius:8px; text-align:center; font-size:12px; font-weight:normal; margin:3px auto">我要发货</a></li>
		<?php }?>
      </ul>
    </div>
