<?php 
	...
	//推荐产品
	$rsProducts = $DB->get("pifa_products","Products_Index,Products_Name,Products_ID,Products_JSON,Products_price_rule,Products_Sales,Products_unit","where Users_ID='".$UsersID."' and Products_IsRecommend=1 and Products_SoldOut=0 order by Products_Index asc,Products_CreateTime desc");
	$c_products = sort_product_list($DB->toArray($rsProducts));
