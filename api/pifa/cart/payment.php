...
$is_login=1;
$owner = get_owner($rsConfig,$UsersID);//登录前
require_once($_SERVER["DOCUMENT_ROOT"].'/include/library/wechatuser.php');
$owner = get_owner($rsConfig,$UsersID);//登录后
if($owner['id'] != '0'){
		...
		<form id="payment_form" action="/api/<?php echo $UsersID ?>/pifa/cart/">
			...
			<div class="i-ture">
				...
				<ul id="pay-btn-panel">
					...
					<li> <a href="/api/<?=$UsersID?>/pifa/cart/complete_pay/huodao/<?=$OrderID?>/" class="btn btn-warning  btn-pay" id="out" data-value="线下支付"><img  src="/static/api/shop/skin/default/huodao.png" width="16px" height="16px"/>&nbsp;线下支付</a> </li>
					<?php }?>
