...
<div id="shop_page_contents">
  ...
  <div id="favourite_list"> 
	<?php if(isset($favourList)):?>
      ...
      <div class="item">
        <div class="del">
          <div cartid="5_0"><a href="/api/<?=$UsersID?>/shop/member/favourite/del/<?=$item['FAVOURITE_ID']?>/?love"><img src="/static/api/shop/skin/default/images/del.gif"></a></div>
        </div>
        <div class="img"><a href="/api/<?=$UsersID?>/shop/products/<?=$key?>/?love"><img src="<?=$item['ImgPath']?>" height="100" width="100"></a></div>
        <dl class="info">
          <dd class="name"><a href="/api/<?=$UsersID?>/shop/products/<?=$key?>/?love"><?=$item['Products_Name']?></a> </dd>
