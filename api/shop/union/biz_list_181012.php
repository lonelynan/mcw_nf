...
if ($_POST) {
    ...
    if ($_POST['choose_type'] == 1) {
        ...
        if (!empty($_POST['biz_name'])) {
            $codtion .= " and Biz_Name like '%" . $_POST['biz_name'] . "%'";
        }
    ...
    if ($_POST['choose_type'] == 2) {
        ...
        if (!empty($_POST['biz_name'])) {
            $codtion .= " and b.Biz_Name like '%" . $_POST['biz_name'] . "%'";
        }
        if (!empty($_POST['biz_cate_id'])) {
    ...
    if ($_POST['choose_type'] == 3) {
        ...
        if (!empty($_POST['biz_name'])) {
            $sql .= " and Biz_Name like '%" . $_POST['biz_name'] . "%'";
        }
        if (!empty($_POST['biz_cate_id'])) {
...
<div class="w">
    <div class="head_sj_bg">
        ...
        <div>
            <input id="biz_name" name="biz_name" type="text" placeholder="请输入商家名称" class="search_sj">
