...
<script type='text/javascript' src='/static/api/shop/biz/<?php echo $rsBiz["Skin_ID"];?>/js/dianpu.js'></script>
<script type="text/javascript">
	var biz_ajax_url = '<?php echo $base_url;?>api/<?php echo $UsersID;?>/shop/biz/<?php echo $rsBiz["Biz_ID"];?>/ajax/';
	$(document).ready(function(){
		dianpu_obj.page_init();
	});
</script>
</head>
<body>
 <div id="header_biz">
  <a class="back"></a><?php echo $header_title;?>
  <!--
  <ul>
   <li><a href="<?php echo $shop_url;?>" class="shop_home">商城首页</a></li>
   <li><a href="<?php echo $shop_url;?>distribute/" class="shop_dis">分销中心</a></li>
