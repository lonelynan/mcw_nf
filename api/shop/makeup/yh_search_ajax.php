						...
						if(type == 0){
							...
							$htmltmp = '<div class="item">'+
									   '<ul>'+
										...
										'<li class="name"><a href="javascript:;" data-url="'+v['link']+'">'+v["Products_Name"]+'</a><span>￥'+v["Products_PriceX"]+'</span></li>'+
									   '</ul>'+
									  '</div>'+
...
<script language="javascript">
function loaded(){
	$("#products img").scrollLoading();
}
$(document).ready(function(){
	document.addEventListener('touchmove', function (e) { $("#products img").scrollLoading(); }, false);
...
$(function(){
	$(".list-1").on("click", ".item ul li a", function(){
