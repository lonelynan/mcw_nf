...
<div id="shop_page_contents">
	...
	<div id="reserve">
	  <form name="reserve_form" action="?" method="post"  id="user_form">
		  ...
		  <table width="100%" cellpadding="0" cellspacing="0" border="0">
			...
			<tbody>
			  ...
			  <tr>
				...
				<?php }else{?>
					<input type="text" name="Invitation_Code" value="" class="form_input" />
				<?php }?>
				</td>
			  </tr>
                          <?php }?>
			  <tr>
				...
				<td><input type="text" name="passwd" placeholder="请输入注册密码" id="passwd" value="" class="form_input" notnull /></td>
			  </tr>
			</tbody>
		  </table>
		</div>
		...
		<div>
                    <input type="button" style="width: 100%;margin: 5px auto;margin-bottom: 0px;box-sizing: border-box;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;background: #f60;padding: 8px;font-size: 18px;border-radius: 5px;color: #fff;" id ="reg" value="立即入驻" />
