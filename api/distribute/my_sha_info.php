...
$shaInfo = $DB->getPage('distribute_sha_rec', '*', ' where `Users_ID`="' .$UsersID. '" AND `Sha_Accountid` like "%,'.$rsAccount['Account_ID'].',%" order by Record_ID desc', 50);
$shaList = array();
...
<div class="wrap">
 ...
 <?php $DB->showWechatPage('/api/'.$UsersID.'/distribute/my_sha_info/'); ?>
