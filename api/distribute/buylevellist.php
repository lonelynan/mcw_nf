...
<header class="bar bar-nav">
  ...
  <h1 class="title"><?php echo empty($rsConfig['DisSwitch'])?'财富账户明细':'分销账户明细'?></h1> 
</header>
...
<div class="wrap">
	<div class="container">
        ...
        <ul id="distribute-brief-info">
         ...
         <li class="item"><a href="<?php echo $distribute_url;?>buylevellist/self/"><span class="red bold">&nbsp;<?=$self_distribute_count?></span><br/><?php echo empty($rsConfig['DisSwitch'])?'自己购买':'自销'?></a></li>
         <li class="item"><a href="<?php echo $distribute_url;?>buylevellist/down/"><span class="red bold">&nbsp;<?=$posterity_distribute_count?></span><br/><?php echo empty($rsConfig['DisSwitch'])?'朋友购买':'下级分销'?> </a></li>
      ...
      <ul class="list-group" id="record-panel">
        ...
        <li class="list-group-item">
        	<p class="record-description">
                        <?php if (empty($rsConfig['DisSwitch'])) {
                                $item['Record_Description'] = str_replace('分销商','级别',$item['Record_Description']);
                            }
                        ?>
