...
<div class="wrap">
	<ul id="withdraw-record-nav" class="list-group">
         <li class="item  <?php if($status == 'all'){echo 'cur';}?>" ><a href="<?=$base_url?>api/<?=$UsersID?>/distribute/withdraw_record/?love" />全部</a></li>
         <li class="item  <?php if($status == '0'){echo 'cur';}?>" ><a href="<?=$base_url?>api/<?=$UsersID?>/distribute/withdraw_record/status/0/?love" />申请中</a></li>
         <li class="item  <?php if($status == '1'){echo 'cur';}?>" ><a href="<?=$base_url?>api/<?=$UsersID?>/distribute/withdraw_record/status/1/?love" />已执行</a></li>
         <li class="item  <?php if($status == '2'){echo 'cur';}?>" ><a href="<?=$base_url?>api/<?=$UsersID?>/distribute/withdraw_record/status/2/?love" />已驳回</a></li>
