...
if ($script_name != '/api/distribute/change_bind.php' && $script_name != '/api/distribute/bind_mobile.php'
	 && $script_name != '/api/distribute/edit_headimg.php') {
	   
if(!$distribute_flag) {
	header("location:".$distribute_url."join/?love");
}
...
if($accountObj->Is_Dongjie==1 || $accountObj->Is_Delete==1){//账号被冻结
	header("location:".$distribute_url."dongjie/?love");
}
