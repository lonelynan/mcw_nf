...
$rs = $DB->GetRs("distribute_account","*","where Users_ID='".$UsersID."' and User_ID=".$User_ID);
if($rs["Is_Delete"]==0&&$rs["Is_Dongjie"]==0){
	die("非法操作");
}
$rsConfig1 = $DB->GetRs('distribute_config','*','where Users_ID="'.$UsersID.'"');
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
 <meta http-equiv="X-UA-Compatible" content="IE=edge">
	...
	<?php if($rsConfig1["Fuxiao_Open"]==1){?>
		<title>复销规则</title>
	<?php }else{?>
