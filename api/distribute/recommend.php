...
<style type="text/css">
	...
	.message_tips{display:block; position:absolute; height:22px; line-height:22px; top:30px; right:8px; color:red}
	.message_send{display:block; position:absolute; height:22px; line-height:22px; top:65px; right:8px; color:#FFF; background:#EEC900; padding:3px 10px; border-radius:5px}
</style>
</head>
...
<?php if ($rsAccount['status']): ?>
	...
	<div class="recommend-box">
		<div class="recommend-line" style="position:relative">
			...
			<a href="/api/<?=$UsersID?>/distribute/my_message/<?=$v['User_ID']?>/" class="message_tips">未读消息：<?php echo $countMessage[$v['User_ID']]; ?></a> 
			<?php endif; ?>
			<a href="/api/<?=$UsersID?>/distribute/my_message/<?=$v['User_ID']?>/" class="message_send">发送消息</a>
