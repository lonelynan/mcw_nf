...
if(isset($_GET['action'])){
	...
	if($action == 'self_kan'){
		...
		if(!empty($_SESSION[$UsersID."User_ID"])){
			if (isset($_GET['from'])) {
				Header("Location:/api/".$UsersID."/kanjia/activity/".$KanjiaID.'/userid/'.$_SESSION[$UsersID."User_ID"].'/');exit;
			}
			//砍价动作
			...
			Header("Location:/api/".$UsersID."/user/login/?wxref=mp.weixin.qq.com");exit;
		}
