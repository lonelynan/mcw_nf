...
if($Method==1){//微支付
	...
	if($rsPay["PaymentWxpayType"]==1){
		header("location:/pay/wxpay2/sendto_kanjia.php?UsersID=".$UsersID."_".$OrderID);
	}else{
		header("location:/pay/wxpay/sendto_kanjia.php?UsersID=".$UsersID."&OrderID=".$OrderID);
	}
}elseif($Method==2){//支付宝
	...
	$pay_orderno = $OrderID;
	$pay_subject = $SiteName."(".$UsersID.")微商城在线付款，订单编号:".$OrderID;
	header("location:/pay/alipay/sendto_kanjia.php?UsersID=".$UsersID."&OrderID=".$OrderID);
}
?>
<!DOCTYPE html>
<html>
