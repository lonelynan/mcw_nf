   ...
   var Users_ID = '<?=$UsersID?>';
	$(document).ready(function(){
		function handler(AddressID){
			var url =  base_url+'api/'+Users_ID+'/shop/cart/checkout/'+AddressID+'/';
			alert(url);
			//window.location.href = base_url+'api/'+Users_ID+'/shop/cart/checkout/'+AddressID+'/';
		}
...
<header class="bar bar-nav">
        ...
        <a href="/api/<?=$UsersID?>/shop/cart/?love" class="pull-right"><img src="/static/api/shop/skin/default/images/cart_two_points.png" /></a>
			...
			?>
				<div  class="row receiver-info">
					<dl>
						...
						<dd class="col-xs-1">
                    <a class="edit_address" href="/api/<?=$UsersID?>/user/my/address/del/<?=$address['Address_ID']?>/"><span class="fa fa-remove red"></span></a>    
