...
$has_cart = strpos($redirect_url,'cart_key');
$redirect_url = beforestr($redirect_url, '?love');
?>
<!DOCTYPE html>
<html>
<head>
...
<script type='text/javascript'>
   ...
   var Users_ID = '<?=$UsersID?>';
	$(document).ready(function(){
		...
		var has_cart = '<?=$has_cart?>';
		function handler(AddressID){
	        if (has_cart !== '') {
                window.location.href = redirect_url+AddressID+'/?cart_key=PTCartList';
            } else {
