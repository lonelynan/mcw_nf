...
<div id="my">
  <form id="user_form">
	...
	<div class="charge_type">
	  <ul>
        ...
        <? if (!empty($rsPay['Payment_OfflineEnabled'])) { ?>
		  <li>
            <input type="radio" name="Operator" value="3" id="xxzf" />
            <label for="xxzf"><strong>线下支付</strong></label>
          </li>
        <? } ?>
	  </ul>
	</div>
    <div class="submit">
      ...
      <a href="javascript:history.back(-1);" class="cancel">取消</a>
	</div>
