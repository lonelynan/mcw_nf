...
<div id="my">
  <div class="list_item"> 
    ...
    <a href="/api/<?php echo $UsersID ?>/user/my/profile/" class="item item_3"><span class="ico"></span>完善我的资料<span class="jt"></span></a>
    ...
    <div class="modify_pay_password item item_12"><span class="ico"></span><a href="/api/<?php echo $UsersID ?>/user/payword/" style="font-size:15px;color:#000">修改支付密码</a><span class="jt0"></span></div>
    <div class="dline"></div>
