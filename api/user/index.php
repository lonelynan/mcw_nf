...
require_once($_SERVER["DOCUMENT_ROOT"].'/include/yinru/pingbi.php');
...
//pingbi处理
if (array_key_exists($UsersID,$pingbi)){
$pbchuli = array();
foreach($pingbi as $key=>$value){
...
$_SESSION[$UsersID."HTTP_REFERER"]="/api/".$UsersID."/shop/wzw/";


//20160910 16:10 add by sxf
$gotoUrl = '/api/' . $UsersID . '/shop/member/?love';
...
$rsUser=$DB->GetRs("user","*","where Users_ID='".$UsersID."' and User_ID=". (int)$_SESSION[$UsersID."User_ID"]);
if(empty($rsUser["User_Profile"])){
	header("location:/api/".$UsersID."/shop/member/setting/");
	exit;
}
$LevelName = '普通会员';
...
<link href='/static/api/css/user.css?t=0612' rel='stylesheet' type='text/css' />
<link href='/static/api/shop/skin/default/style.css?t=0612' rel='stylesheet' type='text/css' />
...
<div id="card">
  <div class="price">
	<a href="/api/<?php echo $UsersID ?>/user/money/"><span class="money"><?php echo $rsUser["User_Money"];?></span>余额</a><a href="/api/<?php echo $UsersID ?>/user/charge/"><span><img src="/static/api/images/user/money.png" width="20" style="margin-bottom:8px" /></span>充值</a><a href="#" title="<?php echo $LevelName;?>"><span class="level"><img src="/static/api/images/user/v<?php echo $rsUser["User_Level"];?>.png" width="20" style="margin-bottom:8px" /></span>会员级别</a><div class="clear"></div>
  </div>
  
  <div class="list_item">
	<div class="dline"></div>
	<a href="/api/<?php echo $UsersID ?>/user/zhuanzhang/" class="item item_13"><span class="ico"></span> 余额转帐</a>
    ...
    <div class="dline"></div>    
    <a href="href="/api/<?php echo $UsersID ?>/shop/<?php echo $_SESSION[$UsersID."User_ID"] ?>/" class="item item_4"><span class="ico"></span>进入商城<span class="jt"></span></a>
	...
	<div class="dline"></div>
	<?php if(!in_array('shitidian',$pbchuli)):?>
