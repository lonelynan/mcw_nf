    ...
    <div id="user_profile" class="r_con_wrap">
      ...
      <form class="r_con_form" id="Profile_form" style="margin-top:10px">
             <div class="rows">
                        ...
                        <table border="0" cellpadding="5" cellspacing="0" class="reverve_field_table">
                            ...
                            <tbody>
                                ...
                                <tr style="display:;" FieldType="select">
                                    ...
                                    <td>
										<?php if($no==1){ ?>
										<a href="javascript:void(0);" class="select_add"><img src="/static/member/images/ico/add.gif" /></a>
										<?php }else{ ?>
										<a href="javascript:void(0);" class="select_del"><img src="/static/member/images/ico/del.gif" /></a>
										<?php } ?>
									</td>
                                </tr>
                                <?php }else{?>
                ...
                <div class="rows">
                    <label>&nbsp;</label>
                    <span class="input"><input type="submit" class="btn_ok" name="submit_button" value="提交保存" /><a href="user_list.php" class="btn_cancel">返回</a></span>
                    <div class="clear"></div>
                </div>
            </form>
    </div>
