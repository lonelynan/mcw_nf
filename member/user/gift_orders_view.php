...
if($_POST){
	...
	if($gift_orders['Gift_ID']){
      ...
      if($gift['Gift_Shipping']) {
		  if($gift_orders['Address_Province']&&$gift_orders['Address_City']&&$gift_orders['Address_Area']){
  ...
  <div class="iframe_content">
    ...
    <div id="gift_orders" class="r_con_wrap">
      <form id="orders_mod_form" method="post" action="gift_orders_view.php" class="r_con_form">
		...
		<?php if($gift_orders['Address_Province']&&$gift_orders['Address_City']&&$gift_orders['Address_Area']){?>
        <div class="rows">
          <label>地址信息</label>
          <span class="input"><span class="tips"><?php echo $gift_orders['Address_Detailed'];?>【<?php echo $area_array[0][$gift_orders['Address_Province']];?>，<?php echo $City;?>，<?php echo $Area;?>】</span></span>
          <div class="clear"></div>
        </div>
		<?php }?>
        <div class="rows">
        ...
        <div class="rows">
		  ...
		  <?php 
		  foreach ($defaut_shipping_addgo as $value) {
		  ?>
		  ...
		  <?php if($gift_orders['Orders_Status']){?>
          <span><?php echo $gift_orders['Orders_ShippingID'];?></span>
		  <?php } else { ?>
