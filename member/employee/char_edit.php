...
if(!empty($_GET['id'])){
        ...
        unset($my_righta['kanjia']);
        unset($my_righta['votes']);
        unset($my_righta['zhongchou']);
        unset($my_righta['zhuli']);
        unset($my_righta['games']);
		   ...
		   <?php foreach($value as $k=>$v){ ?>
			...
			<div class="rows">
                ...
                <span class="input">
                    ...
                    <label><input name="status" type="radio" value="0" <?php if(!$role['status']) echo "checked";?>>禁用</label>
                </span>
                <div class="clear"></div>
            </div>
			<div class="rows">
