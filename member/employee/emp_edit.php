      ...
      <form class="r_con_form" method="post" action="?" id="emp_add_form">
       <div class="rows">
        ...
        <div class="rows">
            ...
            <div class="rows">
                <label>登录密码</label>
                <span class="input"><input type="password" name="emppwd" class="form_input" id="emppwd" /> <font class="fc_red">*</font></span>
                <div class="clear"></div>
            </div>
            <div class="rows">
                <label>到期时间</label>
            ...
            <div class="rows">
                ...
                <span class="input">
                    <select name='role_id'>
						...
						<?php 	$condition = "where users_account='{$_SESSION['Users_Account']}' and status = 1";
			...
			<div class="rows">
                ...
                <span class="input">
                    ...
                    <label><input name="status" type="radio" value="0" <?php if(!$employee['status']) echo "checked";?>>禁用</label>
                </span>
                <div class="clear"></div>
            </div>
			<div class="rows">
