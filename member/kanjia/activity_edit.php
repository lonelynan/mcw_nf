    ...
    <div id="products" class="r_con_wrap">
      ...
      <form class="r_con_form" id="add_form" method="post" action="activity_edit.php?KanjiaID=<?=$Kanjia_ID?>">
       ...
       <div class="rows">
          <label>产品重量</label>
          <span class="input">
			<input name="Weight" type="text" value="<?php echo $Activity["Weight"]; ?>" class="form_input" size="10" /> kg
          </span>
          <div class="clear"></div>
        </div>
		<div class="rows">
          ...
          <span class="input">
            <select name="Shipping">
				<option value="1"<?php echo $Activity["Shipping"]==1 ? ' selected' : ''?>>是</option>
				<option value="0"<?php echo $Activity["Shipping"]==0 ? ' selected' : ''?>>否</option>
			</select>
          </span>
          <div class="clear"></div>
        </div>
