...
{	
	...
	if($Flag){
		session_unset();
		echo '<script language="javascript">alert("修改成功，请重新登陆");window.location="/member/login.php";</script>';exit;
	}else{
		echo '<script language="javascript">alert("修改失败！");window.location="/member/login.php";</script>';exit;
	}
}
?>
<!DOCTYPE HTML>
