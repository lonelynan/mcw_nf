...
$condition = "where Users_ID='".$_SESSION["Users_ID"]."' and Order_Type='pifa'";
...
$condition .= " and Order_Type='pifa' order by Order_CreateTime desc";
...
$(document).ready(pifa_obj.orders_init);
</script>
