...
if($_POST){	
	...
	$_POST['mobile_desc'] = str_replace('"','&quot;',$_POST['mobile_desc']);
	$_POST['mobile_desc'] = str_replace("'","&quot;",$_POST['mobile_desc']);
	$_POST['mobile_desc'] = str_replace('>','&gt;',$_POST['mobile_desc']);
	$_POST['mobile_desc'] = str_replace('<','&lt;',$_POST['mobile_desc']);
    ...
    <div id="products" class="r_con_wrap">
      ...
      <form class="r_con_form" id="group_edit" method="post" action="?">
		...
		<div class="rows">
          ...
          <span class="input">
          <textarea class="ckeditor" name="mobile_desc" style="width:700px; height:300px;"><?php echo !empty($item["mobile_desc"])?$item["mobile_desc"]:''; ?></textarea>
          </span>
          <div class="clear"></div>
        </div>
        <div class="rows">
