    ...
    <div id="products" class="r_con_wrap">
      ...
      <form id="phone_add.php_form" class="r_con_form skipForm" method="post" action="phone_add.php.php">
        ...
        <div class="rows">
          <label>服务名称</label>
          <span class="input">
          <input type="text" name="Name" id="name" value="话费充值" readonly="readonly" class="form_input" size="35" maxlength="100" notnull />
    ...
    <div class="rows form-group">
        <label>充值金额</label>
         <span class="input"  id="money">
             <input type="text" class="ProductsParametername" name="Products_Parameter[0][name]" placeholder="充值现价" value="" class="form_input" size="15" maxlength="30" />
             <input type="text" class="ProductsParametervalue" name="Products_Parameter[0][value]" placeholder="充值原价" value="" class="form_input" size="15" maxlength="30" />
        ...
        <div class="rows" id="type_html">
           ...
           <option value="">请选择类型</option>
               ...
               <!-- <option value="1"><?php echo $type['1']?></option> -->
           </select>
