...
<div id="iframe_page">
  <div class="iframe_content">
    ...
    <div id="products" class="r_con_wrap">
	  ...
	  $distribute_list = $res['Server_Distributes'] ? json_decode($res['Server_Distributes'],true) : array();  //分佣金额列表
       ?>
        ...
        <div class="rows">
          ...
          <input class="res" type="hidden" value=""></input>
 ...
 $('.btn_green').click(function(){
  ...
  var res;
      $.post("Aja.php",{name:name,newmoney:arr,oldmoney:array,price:price,type:type,text:text,provider:provider,usersid:usersid,serverid:serverid,nobi:nobi,commission_ratio:commission_ratio,listDristribute:listDristribute},function(data){
  //对返回值 进行判断
  var res=data.t;
  if (res){
    alert('便民服务更改成功!');
