    ...
    <div id="battle" class="r_con_wrap">
      ...
      <form id="battle_form" class="r_con_form" method="post" action="battle.php">
              ...
              <span class="upload_file">
                    <div class="up_input">
                        <div class="file" style="margin:10px;">
                            ...
                            <input type="hidden" name="ImgPath" id="ImgPath" value="<?php echo empty($Material_Json["ImgPath"])?'':$Material_Json["ImgPath"] ?>" />
                        </div>
                    </div>
                    <div class="clear"></div>
                    <div class="img" id="ImgDetail"><img src="<?php echo empty($Material_Json["ImgPath"])?'':$Material_Json["ImgPath"] ?>" width="640" height="360"></div>
              </span>
          </span>
          <div class="clear"></div>
        </div>
        ...
        <div class="rows">
          <label>背景音乐</label>
          <span class="input">
          <input type="text" name="BackgroundMusic" id="BackgroundMusic" value="<?php echo empty($rsBattle["Battle_BackgroundMusic"])?'/static/api/media/battle_timer.mp3':$rsBattle["Battle_BackgroundMusic"] ?>" class="form_input" size="50" maxlength="10" />
          <input type="checkbox" name="IsSound" value="1"<?php echo empty($rsBattle["Battle_IsSound"])?'':' checked' ?>/>
          <span class="tips">开启背景音乐(音乐在倒数10秒后响起)</span>
                <span class="upload_file">
                    <div class="file" style="margin-top:10px;">
                        ...
                        <input type="hidden" id="MusicPath" name="MusicPath" value="<?php echo empty($rsBattle["Battle_MusicPath"])?'/static/api/media/battle_timer.mp3':$rsBattle["Battle_MusicPath"] ?>" />
