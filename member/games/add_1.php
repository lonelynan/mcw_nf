                ...
                <span class="upload_file">
                    <div class="up_input">
                        <div class="file" style="margin-top:10px;">
                            ...
                            <input type="hidden" name="Property[img]" id="_GameConfigImg" value="/static/api/games/images/apple.png" />
                            <span class="tips">图片建议尺寸：100*100px</span>
                        </div>
                    </div>
                    <div class="clear"></div>
                    <div class="img" id="_GameConfigImgDetail"><img src="/static/api/games/images/subscribe.jpg"></div>
                </span>
            </span>
            <div class="clear"></div>
        </div>
                ...
                <span class="upload_file">
                    <div class="up_input">
                        <div class="file" style="margin-top:10px;">
                            ...
                            <input type="hidden" name="Property[bgimg]" id="_GameBgConfigImg" value="/static/api/games/images/apple.png" />
                            <span class="tips">图片建议尺寸：640*1010px</span>
                        </div>
                    </div>
                    <div class="clear"></div>
                    <div class="img" id="_GameConfigBgImgDetail"><img src="/static/api/games/images/subscribe.jpg"></div>
                </span>
            </span>
            <div class="clear"></div>
        </div>
