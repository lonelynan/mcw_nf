      ...
      <form id="games_form" class="r_con_form">
		...
		<div class="rows">
          ...
          for($i=1;$i<14;$i++){
              ...
              ?>
              <div class="rows">
                  <label>游戏图片<?=$pow ?></label>
                  <span class="input">
                 <span class="upload_file">
                     <div class="file" style="margin-top:10px;">
                         <input type="button" id="GameImg<?=$pow ?>Upload" value="添加图片" style="width:80px;" />
                         <input type="hidden" name="Property[img<?=$pow ?>]" id="Property<?=$pow ?>" value="<?php echo !empty($JSON["img". $pow]) ? $JSON["img" . $pow] : '';?>" />
                         <span class="tips">图片建议尺寸：100*100px</span>
                     </div>
                     <div class="img" id="Img<?=$pow ?>Detail"><img src="<?php echo !empty($JSON["img". $pow]) ? $JSON["img" . $pow] : '';?>"/></div>
                 </span>
               </span>
                  <div class="clear"></div>
              </div>
