        ...
        <div class="rows">
            ...
            <span class="input">
                <span class="upload_file">
                    <div class="up_input">
                        <div class="file" style="margin-top:10px;">
                            <input type="button" id="_GameConfigImgUpload" value="上传图片" style="width:80px;" />
                            <input type="hidden" name="Property[img]" id="_GameConfigImg" value="<?php echo !empty($JSON["img"]) ? $JSON["img"] : '/static/api/games/images/apple.png';?>" />
                            <span class="tips">图片建议尺寸：100*100px</span>
                        </div>
                    </div>
                    <div class="clear"></div>
                    <div class="img" id="_GameConfigImgDetail"><img src="<?php echo !empty($JSON["img"]) ? $JSON["img"] : '/static/api/games/images/apple.png';?>"></div>
                </span>
            </span>
            <div class="clear"></div>
        </div>
        <div class="rows">
            ...
            <span class="input">
                <span class="upload_file">
                    <div class="up_input">
                        <div class="file" style="margin-top:10px;">
                            <input type="button" id="_GameConfigBgImgUpload" value="上传图片" style="width:80px;" />
                            <input type="hidden" name="Property[bgimg]" id="_GameBgConfigImg" value="<?php echo !empty($JSON["bgimg"]) ? $JSON["bgimg"] : '';?>" />
                            <span class="tips">图片建议尺寸：640*1010px</span>
                        </div>
                    </div>
                    <div class="clear"></div>
                    <div class="img" id="_GameConfigBgImgDetail"><img src="<?php echo !empty($JSON["bgimg"]) ? $JSON["bgimg"] : '';?>"></div>
                </span>
            </span>
            <div class="clear"></div>
        </div>
