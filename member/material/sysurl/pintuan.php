        ...
        <tbody>
		  <tr>
            ...
            <td nowrap="nowrap" class="left last">
            	http://<?php echo $rulreal ?>/api/<?php echo $_SESSION["Users_ID"] ?>/pintuan/
            </td>
          </tr>
          <?php
		        $ii = 0;
          ...
          <tr>
            ...
            <td nowrap="nowrap" class="left last">
            	http://<?php echo $rulreal ?>/api/<?php echo $_SESSION["Users_ID"] ?>/pintuan/product/<?php echo $v["Products_ID"];?>/
            </td>
          </tr>
          <?php
		  		}
