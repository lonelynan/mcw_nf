      ...
      <table border="0" cellpadding="5" cellspacing="0" class="r_con_table">
        ...
        <tbody>
          ...
          <tr>
			...
			<?php if($setting_flag){?>
            	http://<?php echo $pcConfig['site_url'] ?>/pc.php/shop/goods/index/UsersID/<?php echo $_SESSION["Users_ID"] ?>/id/<?php echo $v["Products_ID"];?>
			<?php }else{?>
				http://<?php echo $rulreal ?>/pc.php/shop/goods/index/id/<?php echo $v["Products_ID"];?>
			<?php }?>
            </td>
          </tr>
          <?php
