      <table border="0" cellpadding="5" cellspacing="0" class="r_con_table">
        ...
        <tbody>
          <tr>
            ...
            <td nowrap="nowrap" class="left last">http://<?php echo $rulreal ?>/api/<?php echo $_SESSION["Users_ID"] ?>/web/</td>
          </tr>
          <?php
				$lists = array();
          ...
          <tr>
            ...
            <td nowrap="nowrap" class="left last">
            	http://<?php echo $rulreal ?>/api/<?php echo $_SESSION["Users_ID"] ?>/web/column/<?php echo $v["Column_ID"];?>/
            </td>
          </tr>
          <?php
          	if(!empty($v["child"])){
          ...
          <tr>
            ...
            <td nowrap="nowrap" class="left last">
            	http://<?php echo $rulreal ?>/api/<?php echo $_SESSION["Users_ID"] ?>/web/column/<?php echo $value["Column_ID"];?>/
            </td>
          </tr>
		  <?php	}
			}
