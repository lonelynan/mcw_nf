      <table border="0" cellpadding="5" cellspacing="0" class="r_con_table">
        ...
        <tbody>
          <tr>
            ...
            <td nowrap="nowrap" class="left last">http://<?php echo $rulreal ?>/api/<?php echo $_SESSION["Users_ID"] ?>/shop/articles/</td>
          </tr>
		  <?php
				$list_column = array();
				$i = 1;
          ...
          <tr>
            ...
            <td nowrap="nowrap" class="left last">
            	http://<?php echo $rulreal ?>/api/<?php echo $_SESSION["Users_ID"] ?>/shop/articles/category/<?php echo $v["Category_ID"];?>/
            </td>
          </tr>
          <?php
		  		}
