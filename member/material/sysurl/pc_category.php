 ...
 <table border="0" cellpadding="5" cellspacing="0" class="r_con_table">
        ...
        <tbody>
          <tr>
			...
			<?php }else{?>
			http://<?php echo $rulreal ?>/pc.php/shop/index/index/UsersID/<?php echo $_SESSION["Users_ID"]?>
			<?php }?>
			</td>
          </tr>
          <?php
          ...
          <tr>
			...
			<?php }else{?>
			http://<?php echo $rulreal ?>/pc.php/shop/list/index/UsersID/<?php echo $_SESSION["Users_ID"] ?>/id/<?php echo $v["Category_ID"];?>
			<?php }?>
            </td>
          </tr>
          <?php
