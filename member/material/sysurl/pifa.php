      <table border="0" cellpadding="5" cellspacing="0" class="r_con_table">
        ...
        <tbody>
		  <tr>
            ...
            <td nowrap="nowrap">批发首页</td>
            <td nowrap="nowrap" class="left last">
            	http://<?php echo $rulreal ?>/api/<?php echo $_SESSION["Users_ID"] ?>/pifa/
            </td>
          </tr>
          <?php
		        $ii = 0;
          ...
          <tr>
            ...
            <td nowrap="nowrap" class="left last">
            	http://<?php echo $rulreal ?>/api/<?php echo $_SESSION["Users_ID"] ?>/pifa/product/<?php echo $v["Products_ID"];?>/
            </td>
          </tr>
          <?php
		  		}
