<table border="0" cellpadding="5" cellspacing="0" class="r_con_table">
    ...
    <?php
    $lists = array();
    $DB->get("biz_union_category","Category_ID,Category_Name,Category_ParentID","where Users_ID='".$_SESSION["Users_ID"]."' order by Category_ParentID asc,Category_IndexShow asc,Category_ID asc");
    ...
    foreach($lists as $k=>$v){
        ...
        <tr>
            ...
            <td nowrap="nowrap" class="left last">
                ../shangjia_list/shangjia_list?Cate_ID=<?=$v['Category_ID']?>
            </td>
        </tr>
        <?php
        if(!empty($v["child"])){
            foreach($v["child"] as $key=>$value){
                ...
                <tr>
                    ...
                    <td nowrap="nowrap" class="left last">
                        ../shangjia_list/shangjia_list?Cate_ID=<?=$value['Category_ID']?>
                    </td>
                </tr>
            <?php	}
        }
