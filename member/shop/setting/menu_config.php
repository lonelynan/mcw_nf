...
$DefaultMenu = array(
	'menu' => array(
		array('menu_name' => '首页', 'login_menu_name' => '首页', 'icon' => 'fa fa-home fa-2x','icon_on' => '/static/api/distribute/images/shouye1.png','icon_up' => '/static/api/distribute/images/shouye.png', 'menu_href' => '/api/' . $_SESSION['Users_ID'] . '/shop/union/', 'login_menu_href' => '/api/' . $_SESSION['Users_ID'] . '/shop/union/', 'bind_action_attr' => 0, 'menu_order' => '1'),
		array('menu_name' => '购物', 'login_menu_name' => '购物', 'icon' => 'fa fa-cart-plus fa-2x', 'icon_on' => '/static/api/distribute/images/gwc1.png','icon_up' => '/static/api/distribute/images/gwc.png', 'menu_href' => '/api/' . $_SESSION['Users_ID'] . '/shop/wzw/', 'login_menu_href' => '/api/' . $_SESSION['Users_ID'] . '/shop/wzw/', 'bind_action_attr' => 0, 'menu_order' => '2'),
		array('menu_name' => '开店', 'login_menu_name' => '开店', 'icon' => 'fa fa-shopping-bag fa-6x', 'icon_on' => '/static/api/distribute/images/center_x1.png','icon_up' => '/static/api/distribute/images/center_x.png','menu_href' => '/api/' . $_SESSION['Users_ID'] . '/distribute/join/', 'login_menu_href' => '/api/' . $_SESSION['Users_ID'] . '/distribute/', 'bind_action_attr' => 1, 'menu_order' => '3'),
		array('menu_name' => '我的', 'login_menu_name' => '我的', 'icon' => 'fa fa-user fa-2x', 'icon_on' => '/static/api/distribute/images/hyzx1.png','icon_up' => '/static/api/distribute/images/hyzx.png', 'menu_href' => '/api/' . $_SESSION['Users_ID'] . '/shop/member/', 'login_menu_href' => '/api/' . $_SESSION['Users_ID'] . '/shop/member/', 'bind_action_attr' => 0, 'menu_order' => '4'),
	)
);
			...
			<?php }else{?>
				...
				<div class="opt_item rows">
	              ...
	              <span class="input" id="span_type_sun">
					...
					<input type="radio" name="menu[<?php echo $k; ?>][icon]" 
					<?php if(!empty($v['icon']) && $v['icon'] == "fa fa-shopping-bag fa-6x"){?>checked<?php } ?>
