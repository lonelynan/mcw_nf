...
<div id="iframe_page">
  <div class="iframe_content">
    ...
    var Skin_ID  = "<?php echo $rsConfig['Skin_ID'];?>";
    $(function(){
        shop_obj.diy_init();
                              ...
                              if($value['list_type'] == '1') {
                                echo '<div class="chanpint_x">
                                  <ul>';
                                    for($i=0;$i<$num;$i++) {
                                      echo '<li>
                                        <a href="#"><span class="cpt_x l"><img src="/static/api/shop/skin/'.$rsConfig['Skin_ID'].'/tp01.jpg"></span></a>
                                        <span class="cpxq_x l">
                                          ...
                                          if(isset($cart)) {
                                            echo '<span class="r" style="margin-top:3px;"><img src="/static/api/shop/skin/'.$rsConfig['Skin_ID'].'/gwct_x.png" width="20" height="20"></span>';
                                          }
                                        echo '</span>
                                      </li>';  
                                    }
                                ...
                                echo '<div class="chanpint1_x">
                                  ...
                                  for($i=0; $i<$num; $i++) {
                                    echo '<li>
                                      <a href="#"><span class="cpt_x"><img src="/static/api/shop/skin/'.$rsConfig['Skin_ID'].'/tp01.jpg"></span></a>
                                        <div class="cpxq1_x">
                                          <div class="cpbt_x"><a href="#">蛋糕蛋糕蛋糕蛋糕</a></div>';
                                          if(isset($integration)) {
                                ...
                                echo '<div class="chanpint2_x">
                                  ...
                                  for($i=0;$i<$num;$i++) {
                                    echo '<li>
                                      <a href="#"><span class="cpt_x"><img src="/static/api/shop/skin/'.$rsConfig['Skin_ID'].'/tp03.jpg"></span></a>
                                        <div class="cpxq1_x">
                                          <div class="cpbt_x"><a href="#">蛋糕蛋糕蛋糕蛋糕</a></div> ';
                                          if(isset($integration)) {
                                ...
                                echo '<div class="chanpint3_x">
                                  ...
                                  for($i = 0;$i < $n;$i++){
                                    echo '<li>
                                      <span class="big_pr l">
                                        <a href="#">';
                                        echo '<div class="pic"><img src="/static/api/shop/skin/'.$rsConfig['Skin_ID'].'/tp01.jpg"></div>';
                                        if(isset($cart)){
                                          echo '<div class="name">小苹果小苹果小苹果小苹果小苹果小苹果小苹果<br><span class="price l">￥123.00</span><span class="r" style="margin-top:3px; margin-right:3px"><img src="/static/api/shop/skin/'.$rsConfig['Skin_ID'].'/gwct_x.png" width="20" height="20"></span></div>';
                                        }else{
                                      ...
                                      <span class="smal_pr l">
                                        <div class="small_pr">
                                              ...
                                              <span class="pic l"><img src="/static/api/shop/skin/'.$rsConfig['Skin_ID'].'/tp03.jpg"></span>
                                              </a>
                                          </div> 
                                          <div class="clear"></div>
                                          <div>
                                              <a href="#">
                                              <span class="name l"><span class="price">￥150.00</span><br>阿卡卡</span>
                                              <span class="pic l"><img src="/static/api/shop/skin/'.$rsConfig['Skin_ID'].'/tp02.jpg"></span>
                                              </a>
                                          </div>                  
                                      </span>
                                    </li>';  
