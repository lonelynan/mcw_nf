          ...
          <tr>
            <td valign="top" class="payment" width="34%"><form action="" method="post" id="web_payment_form"  >
                <ul>
							...
							<li>
								<h1><label>QQ登录<span><input type="checkbox" value="1"  id="check_1" name="config[qq][state]" <?php echo $rsConfig["qq"]['state'] ? 'checked' : '';?> />启用  <a href="http://connect.qq.com" target="_blank">申请</a></span></span></label></h1>
