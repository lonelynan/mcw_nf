			...
			<div class="category">
				...
				while($rsPCategory=$DB->fetch_assoc()){
					echo '<option value="'.$rsPCategory["Category_ID"].'">&nbsp;├'.$rsPCategory["Category_Name"].'</option>';
                        ...
                        <div class="opt_item" id="head_img" style="display: block">
                            ...
                            <br/>
                            （建议尺寸：750px * 240px）
                            <div class="img" id="ImgDetail_head"><img width="100" src="/static/member/images/shop/nopic.jpg" /></div>
                            <input type="hidden" id="ImgPath_head" name="ImgPath_head" value="" />
                            <div classs="pro-list-type"> </div>
                            <div class="clear"></div>
                        </div>
