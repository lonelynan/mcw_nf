            ...
            <td valign="top" class="payment" width="34%"><form action="" method="post" id="web_payment_form"  >
                <ul>
							...
							<li style="display:none">
								<h1><label>微信登录<span><input type="checkbox" value="1" id="check_0" name="config[weixin][state]" <?php echo $rsConfig["weixin"]['state'] ? 'checked' : '';?> />启用 </label></h1>
							...
							<li>
								<h1><label>QQ登录<span><input type="checkbox" value="1"  id="check_1" name="config[qq][state]" <?php echo $rsConfig["qq"]['state'] ? 'checked' : '';?> />启用  <a href="https://connect.qq.com/" target="_blank">申请</a></span></span></label></h1>
