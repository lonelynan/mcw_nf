...
<html>
  <head>
      <link rel="stylesheet" href="/static/member/css/cureentprint.css?t=1" type="text/css"/>
      <!-- 让打印的页面有样式，media="print" 不能应用到web页面 -->
      <link rel="stylesheet" href="/static/member/css/cureentprint.css?t=1" type="text/css" media="print"/>
      ...
      <?php foreach($orderlist as $Key => $order): ?>
          ...
          <table width="100%" cellpadding="1" style="margin-bottom: 50px;">
          	 ...
          	 <tbody>
                  ...
                  ?>
          	 			<p><span  class="lbl">商品名称：</span><span><?=$v['ProductsName']?>（￥<?= $price ?>）</span>
          	 			<span class="pd100">数量：<?=$v['Qty']?>&nbsp;总价：￥<?= $price * $v['Qty'] ?></span></p>
