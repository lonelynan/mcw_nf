          ...
          <form action="shop_attr_edit.php" method="post" id="shop_attr_edit_form">
           ...
           <div class="opt_item">
            ...
            <div class="opt_item">
       	    ...
       	    <input type="hidden" name="typeid_re" value="<?php echo $rsAttr['Type_ID'];?>">    
            ...
            <div class="opt_item">
              <label></label>
              <span class="input">
              <input type="submit" class="btn_green btn_w_120" name="submit_button" value="修改属性" onClick="if(!confirm('新增或减少属性后请更新产品,否则将安默认显示')) return false;"/>
