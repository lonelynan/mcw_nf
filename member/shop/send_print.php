...
if($_POST){
	...
	$_SESSION["Biz_Contact"] = $_POST['Contact'];
	$_SESSION["Biz_Phone"] = $_POST['Phone'];
	$_SESSION["Biz_Name"] = $_POST['Name'];
	$_SESSION["Biz_Address"] = $_POST['Address'];
	$_SESSION["Province_one"] = $_POST['Province'];
	$_SESSION["City_two"] = $_POST['City'];
	$_SESSION["Area_three"] = $_POST['Area'];
...
<table cellpadding="0" cellspacing="0" width="500">
    ...
    <tr>
        ...
        <td><input name="Contact" class="input" value="<?php echo isset($_SESSION["Biz_Contact"]) ? $_SESSION["Biz_Contact"] : ''?>"></td>
    </tr>
    <tr>
    	<td class="left">发货人电话</td>
        <td><input name="Phone" class="input" value="<?php echo isset($_SESSION["Biz_Phone"]) ? $_SESSION["Biz_Phone"] : ''?>"></td>
    </tr>
    <tr>
    	<td class="left">发货人公司</td>
        <td><input name="Name" class="input" value="<?php echo isset($_SESSION["Biz_Name"]) ? $_SESSION["Biz_Name"] : ''?>"></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><input name="Address" class="input" value="<?php echo isset($_SESSION["Biz_Address"]) ? $_SESSION["Biz_Address"] : ''?>"></td>
    </tr>
    <tr>
...
$(document).ready(function() {
	var Province_one = <?php echo isset($_SESSION["Province_one"]) ? $_SESSION["Province_one"] : 0; ?>;
	var City_two = <?php echo isset($_SESSION["City_two"]) ? $_SESSION["City_two"] : 0; ?>;
	var Area_three = <?php echo isset($_SESSION["Area_three"]) ? $_SESSION["Area_three"] : 0; ?>;
	showLocation(Province_one,City_two,Area_three);
