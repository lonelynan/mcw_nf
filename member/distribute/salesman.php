      ...
      <table border="0" cellpadding="5" cellspacing="0" class="r_con_table" id="order_list">
        <thead>
          <tr>
            ...
            <td width="16%" nowrap="nowrap">推荐商家</td>
            <td width="16%" nowrap="nowrap">我的邀请码</td>
		...
		?>
          <tr>
            ...
            <td nowrap="nowrap"><?php echo $item["company"].'个'; ?></td>
            <td nowrap="nowrap"><?php echo $item["Invitation_Code"]; ?></td>
