...
if (!empty($_POST)) 
{
  $s = json_encode(array('myterm'=>$_POST['my_term'], 'childlevelterm'=>$_POST['child_level_term'], 'catcommission' => $_POST['catcommission'], 'cattuijian' => $_POST['cattuijian']), JSON_UNESCAPED_UNICODE);
