...
if($_POST){	
	...
	$dis_config->Distribute_UpgradeWay = $_POST['Distribute_UpgradeWay'];
...
<script type='text/javascript' src='/static/member/js/distribute/config.js?t=1'></script>
    ...
    <div class="r_con_wrap">
      <form id="distribute_config_form" class="r_con_form" method="post" action="?">
		...
		<div class="rows">
        	<label>分销商升级方式</label>
            <span class="input">
				<input type="radio" id="zhuji" name="Distribute_UpgradeWay" <?php echo $rsConfig['Distribute_UpgradeWay']==0 ? ' checked' : ''?> value="0"> <label for="zhuji">逐级升级</label>
				<input type="radio" id="tiaoji" name="Distribute_UpgradeWay" <?php echo $rsConfig['Distribute_UpgradeWay']==1 ? ' checked' : ''?> value="1"> <label for="tiaoji">跳级升级</label>
            </span>
            <div class="clear"></div>
        </div>
        <div class="rows">
