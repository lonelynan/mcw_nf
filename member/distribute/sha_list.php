  ...
  <div class="iframe_content">
      ...
      <table width="100%" align="center" border="0" cellpadding="5" cellspacing="0" class="r_con_table">
        <thead>
          <tr>
			...
			<td width="30%" nowrap="nowrap">股东类型</td>						
        ...
        <tbody>	
		  ...
		  $DB->getPage("distribute_account","User_ID,Account_ID,Real_Name,sha_level,Enable_Agent",$condition,$psize);		  
		  /*获取订单列表牵扯到的分销商*/
		  $sha_list = array();		  
		  $userid = array();
		  $accid = array();
	...
	<?php foreach($newsha_list as $key=>$record):?>
           <tr>
            ...
            <td><?=$shaarr['sha'][$record['sha_level']]['name']?></td>
