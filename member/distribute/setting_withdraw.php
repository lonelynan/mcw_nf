...
if($_POST){
	...
	$dis_config->Withdraw_Date = $_POST['Type_date'];
	if($_POST['Type']==2){
...
<script type='text/javascript' src='/static/member/js/distribute/config.js?t=10123458'></script>
      ...
      <form id="distribute_config_form" class="r_con_form" method="post" action="?">
		<div class="rows">
          ...
          <span class="input">
          	<select name="Type_date">
				<option value="7"<?php echo $rsConfig["Withdraw_Date"]==7 ? ' selected' : '';?>>无限制</option>
             	<option value="0"<?php echo $rsConfig["Withdraw_Date"]==0 ? ' selected' : '';?>>周日</option>
                <option value="1"<?php echo $rsConfig["Withdraw_Date"]==1 ? ' selected' : '';?>>周一</option>
                <option value="2"<?php echo $rsConfig["Withdraw_Date"]==2 ? ' selected' : '';?>>周二</option>
				<option value="3"<?php echo $rsConfig["Withdraw_Date"]==3 ? ' selected' : '';?>>周三</option>
				<option value="4"<?php echo $rsConfig["Withdraw_Date"]==4 ? ' selected' : '';?>>周四</option>
				<option value="5"<?php echo $rsConfig["Withdraw_Date"]==5 ? ' selected' : '';?>>周五</option>
				<option value="6"<?php echo $rsConfig["Withdraw_Date"]==6 ? ' selected' : '';?>>周六</option>				
           	</select>
          </span>
          <div class="clear"></div>
        </div>
        ...
        <div id="type_2"<?php echo $rsConfig["Withdraw_Type"] != 2 ? ' style="display:none"' : '';?>>
			...
			<div class="rows">
               <label>选择商品</label>
               <span class="input">
                <label><input type="radio" name="Fanwei" id="Fanwei_0" value="0"<?php echo $rsConfig["Withdraw_Type"]<>2 || $withdraw_limit[0]==0 ? ' checked' : ''?> />任意商品</label>&nbsp;&nbsp;<label><input type="radio" name="Fanwei" id="Fanwei_1" value="1"<?php echo $rsConfig["Withdraw_Type"]==2 && $withdraw_limit[0]==1 ? ' checked' : ''?> />特定商品</label>
