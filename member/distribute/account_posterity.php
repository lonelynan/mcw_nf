    ...
    <!-- level filter end -->
    	...
    	<div id="level_filter_panel">
          ...
          <tbody><tr bgcolor="#f5f5f5">
            ...
            <td width="100" align="center"><strong>分销商等级</strong></td>
            ...
            <td width="100" align="center"><strong>加入时间</strong></td>
				  ...
				  $rsLevel = $DB->GetRs("distribute_level",'Level_Name',"where Level_ID=".$item['Level_ID']);
				  ?>
                      <?php $total_income = round_pad_zero(get_my_leiji_income($_SESSION['Users_ID'],$item['User_ID']),2);?>
